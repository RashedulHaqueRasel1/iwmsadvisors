    ...
    <section className="relative w-full min-h-[50vh]">
      ...
      <div className="container mx-auto flex min-h-[50vh] items-center justify-start px-8 py-8 md:py-20 reveal">
        <div className="text-left w-full md:w-2/3 lg:w-1/2">
          <h1 className="text-3xl font-bold text-white drop-shadow-lg md:text-5xl lg:text-6xl whitespace-pre-line">
            {heroTitle}
          </h1>
          <p className="text-xl font-normal leading-[140%] mt-2 text-white whitespace-pre-line">
            {heroSubtitle}
          </p>
