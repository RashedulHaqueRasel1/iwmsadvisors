          ...
          <div className="p-8 md:p-12">
            ...
            <div className="border-t border-gray-100 pt-10">
              <Link
                ...
                className="inline-block w-full md:w-auto px-12 py-4 bg-primary text-white font-bold text-lg rounded-2xl hover:bg-primary/80 transition-all shadow-lg hover:shadow-xl transform  text-center whitespace-pre-line"
              >
